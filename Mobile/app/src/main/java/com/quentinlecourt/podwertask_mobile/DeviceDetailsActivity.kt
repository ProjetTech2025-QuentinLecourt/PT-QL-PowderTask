...
class MaterialsDetailsActivity : AppCompatActivity() {
    ...
    private fun setupSampleData() {
        ...
        // Accéléromètre
        accelerometerStatusTextView.text = getString(R.string.on_move)
        accelerometerStatusTextView.setBackgroundResource(R.drawable.medium_status)
        ...
        // Capteur de poids
        weightSensorStatusTextView.text = getString(R.string.incoherent)
        weightSensorStatusTextView.setBackgroundResource(R.drawable.medium_status) // Supposons que vous avez ce drawable
        weightValueStatusTextView.text = "2.5 kg"
        calibrationIndexTextView.text = "0.98"

        // Affichage pour l'écran
        stoneDisplayStatusTextView.text = getString(R.string.problem)
        stoneDisplayStatusTextView.setBackgroundResource(R.drawable.offline_status)
